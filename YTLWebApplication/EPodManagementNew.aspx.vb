...
Partial Class EPodManagementNew
    ...
    Protected Sub DisplayLogInformation()
        Try
            ...
            Dim conn As New SqlConnection(System.Configuration.ConfigurationManager.AppSettings("sqlserverconnection2"))
            Dim sqlQuery As String = "select m.destination_sitename, m.source_supply,m.plateno,E.DivStatus,M.transporter as transporter,M.Dn_No,E.Patch_No,M.Weight_outtime,E.SubmittedBy as driver_ic,E.QrCode,E.SubmittedDateTime,E.Lat,E.Lon,E.UploadStatus from (select * from oss_patch_out where Weight_outtime  between @from and @to  " & condition & ") as M left outer join (select * from OSS_EXTENSION_TABLE  " & statuscond & ") as E   on M.patch_no=E.Patch_no"
            If ddlstatus.SelectedValue <> "-1" Then
                sqlQuery = "select  m.destination_sitename, m.source_supply,m.plateno,E.DivStatus,M.transporter as transporter, M.Dn_No,E.Patch_No,M.Weight_outtime,E.SubmittedBy as driver_ic,E.QrCode,E.SubmittedDateTime,E.Lat,E.Lon,E.UploadStatus from (select * from OSS_EXTENSION_TABLE  " & statuscond & ") as E inner join  (select * from oss_patch_out where Weight_outtime  between @from and @to  " & condition & ") as M   on M.patch_no=E.Patch_no"
            End If
            ...
            Try
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    For ii As Integer = 0 To ds.Tables(0).Rows.Count - 1
                        ...
                        r(8) = ds.Tables(0).Rows(ii)("transporter")
                        ...
                        If IsDBNull(ds.Tables(0).Rows(ii)("DivStatus")) Then
                            r(11) = "No"
                        Else
                            If ds.Tables(0).Rows(ii)("DivStatus") Then
                                r(11) = "Yes"
                            Else
                                r(11) = "No"
                            End If
                        ...
                        If IsDBNull(ds.Tables(0).Rows(ii)("plateno")) Then
                            r(12) = ""
                        Else
                            r(12) = ds.Tables(0).Rows(ii)("plateno").ToString()
                        End If

                        If IsDBNull(ds.Tables(0).Rows(ii)("source_supply")) Then
                            r(13) = ""
                        Else
                            r(13) = ds.Tables(0).Rows(ii)("source_supply").ToString()
                        End If

                        If IsDBNull(ds.Tables(0).Rows(ii)("destination_sitename")) Then
                            r(14) = ""
                        Else
                            r(14) = ds.Tables(0).Rows(ii)("destination_sitename").ToString()
                        End If
        ...
        Catch ex As Exception
            Response.Write("<br/> outer : " & ex.StackTrace)
        End Try
